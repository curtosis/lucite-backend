...
describe JudgesController do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested judge" do
        ...
        Judge.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => judge.id, :judge => {'these' => 'params'}
      end

      it "assigns the requested judge as @judge" do
        judge = Judge.create! valid_attributes
        put :update, :id => judge.id, :judge => valid_attributes
        assigns(:judge).should eq(judge)
      end
    ...
    describe "with invalid params" do
      it "assigns the judge as @judge" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Judge.any_instance.stub(:save).and_return(false)
        put :update, :id => judge.id.to_s, :judge => {}
        assigns(:judge).should eq(judge)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested judge" do
      judge = Judge.create! valid_attributes
      expect {
        delete :destroy, :id => judge.id.to_s
      }.to change(Judge, :count).by(-1)
    end
